            ...
            <div className="container">
              <div className="row wow fadeInUp" data-wow-delay=".2s">
                <div className="col-lg-12">
                  ...
                  <p><strong className="dorado">POLIZA DE RENTAS, Corporativo Póliza de Rentas, S.A de C.V.</strong>, con domicilio ubicado en                   Prolongación 5 de Mayo 1567, Planta Alta, Col. Comisión Federal de Electricidad, Toluca, Estado de México, C.P. 50150, sus sucursales, despachos afiliados y licenciatarios y/o franquiciatarios, al momento de recabar sus datos personales, es responsable del uso que se les dé a los mismos y de su protección.</p>
